...
bucket        = "pub-prac-terraform-stanaya"
...
resource "aws_s3_bucket" "private_bucket" {
  ...
  # バケット名称を任意の名前で定義
  # ※ここの値は変更してください。バケット名は全世界で一意である必要があります
  bucket        = "priv-prac-terraform-stanaya"
  ...
  # タグを設定
  tags = {
    Name = "priv-prac-terraform-stanaya"
  }
...
resource "aws_s3_bucket" "alb_access_log" {
  ...
  # バケット名称を任意の名前で定義
  # ※ここの値は変更してください。バケット名は全世界で一意である必要があります
  bucket = "alb-prac-terraform-stanaya"
  ...
  # タグを設定
  tags = {
    Name = "alb-prac-terraform-stanaya"
  }
  ...
  "Statement": [
    {
      ...
      "Action": "s3:PutObject",
      "Resource": "arn:aws:s3:::alb-prac-terraform-stanaya/*"
    },
    {
      "Effect": "Allow",
      "Principal": {
